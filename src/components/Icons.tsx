...
export function RoutinesIcon({ size = 20, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect width="16" height="20" x="4" y="2" rx="2" ry="2" />
      <path d="M9 22H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3" />
      <path d="M16 11h6" />
      <path d="M16 15h6" />
      <path d="M16 19h6" />
...
export function HistoryIcon({ size = 20, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function ToolsIcon({ size = 20, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function BarbellIcon({ size = 20, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <line x1="2" y1="12" x2="22" y2="12" strokeWidth="2.5" />
      <rect x="5" y="6" width="3" height="12" rx="1" fill={color} />
      <rect x="8" y="4" width="2.5" height="16" rx="1" fill={color} />
      <rect x="16" y="6" width="3" height="12" rx="1" fill={color} />
      <rect x="13.5" y="4" width="2.5" height="16" rx="1" fill={color} />
      <rect x="3" y="10" width="1" height="4" rx="0.5" />
      <rect x="20" y="10" width="1" height="4" rx="0.5" />
    </svg>
  );
}
...
export function DumbbellIcon({ size = 20, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="m21 21-1-1" />
      <path d="m3 3 1 1" />
      <path d="m18.5 5.5 3 3-3.5 3.5-3-3Z" />
      <path d="m2 15.5 3.5-3.5 3 3-3 3Z" />
    </svg>
  );
}
...
export function CalculatorIcon({ size = 20, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function EmailIcon({ size = 20, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
